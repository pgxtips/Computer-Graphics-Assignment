...
ExampleInteractionHandler::ExampleInteractionHandler(KEY_FUNC* pFunc): m_pFunc(pFunc)
{
}

ExampleInteractionHandler::~ExampleInteractionHandler()
{
}

bool ExampleInteractionHandler::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa, osg::Object*, osg::NodeVisitor*)
{
